...
def collisions():
    ...
    callback = lambda s1, s2: pygame.sprite.collide_mask(s1, s2) is not None
    if pygame.sprite.spritecollide(player, meteor_sprites, True, callback):
        running = False
...
def display_score():
    ...
    pygame.draw.rect(
        display_surface, (240, 240, 240), text_rect.inflate(20, 10).move(0, -2), 4, 10
    )
