...
- 1: [Introduction](2/2/e1.py) - functions in module draw 
- 2: [Particle swarm /1](2/2/e2.py) - draw.circle, pygame mouse support
- 3: [Particle swarm /2](2/2/e3.py) - some randomness
- 4: [Particle swarm /3](2/2/e4.py) - mutable particles, fountain effect
- 5: [Particle swarm /4](2/2/e5.py) - add x-scattering
- 6: [Particle swarm /6](2/2/e6.py) - more features added
- 7: [Landscape example](2/2/e7.py)
