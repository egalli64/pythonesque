...
- 1: [Hello pygame](2/s1/e1.py) - init and quit
- 2: [Hello again, pygame](2/s1/e2.py) - Window
- 3: [It's me again, pygame](2/s1/e3.py) - Clock
- 4: [Multiple windows](2/s1/e4.py) - WINDOWCLOSE event

## Section 2 - Graphic primitives
- 1: [Introduction](2/s2/e1.py) - functions in module draw 
- 2: [Particle swarm /1](2/s2/e2.py) - draw.circle, pygame mouse support
- 3: [Particle swarm /2](2/s2/e3.py) - some randomness
- 4: [Particle swarm /3](2/s2/e4.py) - mutable particles, fountain effect
- 5: [Particle swarm /4](2/s2/e5.py) - add x-scattering
- 6: [Particle swarm /6](2/s2/e6.py) - more features added
- 7: [Landscape example](2/s2/e7.py)

## Section 3 - Load and blit bitmaps
- 1: [Load and blit](2/s3/e1.py)
- 2: [Partial blitting](2/s3/e2.py)
- 3: [Message boxes](2/s3/e3.py)
- 4: [Landscape blit](2/s3/e4.py) - !!! Caching surfaces is not useful in such simple cases !!!
