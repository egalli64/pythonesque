...
- 1: [Types of collision](c2/s08/e1/main.py)
- 2: [Collision with a group](c2/s08/e2/game.py)

## Section 9 Time-based Actions
- 1: [The need of having a break](c2/s09/e1.py)
...
# Chapter 4 - Examples
- 1: [Pong](c4/pong/game.py)
- 2: [Bubbles](c4/bubbles/game.py)
- 3: [Moon Lander](c4/moonlander/game.py)
